...
CategoryDragon.create!([
  ...
  {category_id: 2, dragon_id: 10},
  {category_id: 4, dragon_id: 10}
])
Image.create!([
  ...
  {url: "http://cdn.shopify.com/s/files/1/0995/2620/files/Falkor_large.jpg?9334199839447522413", dragon_id: 10},
